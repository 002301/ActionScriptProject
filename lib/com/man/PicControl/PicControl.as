package com.man.PicControl
{
	...
	{
		protected var _Cont:Object; //切换内容
		protected var _total:Number; //总数
		protected var _currentNum:Number; //当前索引
		protected var _currentMC:Object; //当前影片剪辑
		 ...
		 * @auto  到底后是否连续切换，
		 * */
		public function init(Cont:Object, l:Object, r:Object):void
		{
			_Cont = Cont;
		...
		public function get Cont():Object
		{
			return _Cont;
		}
		
		public function set Cont(value:Object):void
		{
			_Cont = value;
		}
		...
		public function get currentMC():Object
		{
			return _currentMC;
		}
